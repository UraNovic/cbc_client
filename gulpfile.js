...
gulp.task('less', function () {
  return gulp.src('src/less/cbc/web.less')
    .pipe($.less({
      paths: ['src/less']
    }))
...
gulp.task('static', function() {
  // cbc.txt and mixpanel script
  var rpl = gulp.src(['cbc.txt', 'deps/js/mixpanel.js'])
