...
var module = angular
  .module('federation', [])
  .factory('rpFederation', rpFederation);

rpFederation.$inject = ['$q', '$rootScope', 'rpcbcTxt'];

function rpFederation($q, $scope, $txt) {
  var txts = {};
  ...
  function checkEmail(email) {
    ...
    function handleNoTxt() {
      federationPromise.reject({
        result: 'error',
        error: 'nocbcTxt',
        error_message: 'cbc.txt not available for the requested domain.'
      });
    }
