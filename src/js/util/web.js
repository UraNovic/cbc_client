...
exports.stripcbcAddress = function (addr)
{
...
exports.resolveContact = function (contacts, value)
{
  ...
  if (cbc.UInt160.is_valid(value)) {
    return cbc.UInt160.json_rewrite(value);
  }
...
/**
 * Regex check if the string is a valid cbc name
 *
 * @param str
 */
exports.iscbcName = function (str)
{
