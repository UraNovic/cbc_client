    ...
    function ($scope, id, $routeParams, $http, authflow, network, txQueue, $location, rpTracker)
    {
      ...
      $scope.getQuote = function() {
        ...
        $http({
          ...
          url: Options.snapswapApi + '/cbc/' + id.account + '/balance/USD/deposit/instantKnox?amount=' + $scope.usdAmount
        })
      ...
      $scope.prepareTrust = function() {
        ...
        tx.cbcLineSet(id.account, trustAmount + '/' + currency + '/' + issuer);
        tx.setFlags('Nocbc');
      ...
      $scope.confirm = function() {
        ...
        $http({
          ...
          url: Options.snapswapApi + '/cbc/' + id.account + '/balance/USD/deposit/instantKnox'
        }).success(function(data){
      ...
      $scope.cancel = function() {
        $http({
          method: 'DELETE',
          url: Options.snapswapApi + '/cbc/' + id.account + '/processing/instantKnox'
